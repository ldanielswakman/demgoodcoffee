<?
$image_url = ($site->meta_image()->isNotEmpty()) ? $site->image($site->meta_image())->thumb(['width' => 1200])->url() : url('assets/images/meta-image.jpg');
...
<meta test="<?= $site->image($site->meta_image())->thumb(['width' => 1200])->url() ?>" />
